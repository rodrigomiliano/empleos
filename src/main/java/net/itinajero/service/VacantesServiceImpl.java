	...
	public VacantesServiceImpl() {
		SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
		 ...
		 try {
			 ...
			 vacante2.setId(2);
			 vacante2.setNombre("Contador Publico"); //Título de la vacante
			 ...
			 vacante3.setId(3);
			 vacante3.setNombre("Ingeniero Electrico"); //Título de la vacante
			...
			// Creamos la oferta de Trabajo 4.
			 ...
			 vacante4.setId(4);
			 vacante4.setNombre("Diseñador Grafico"); //Título de la vacante
